...
now=datetime.now()
filenm = 'https://www.ecdc.europa.eu/sites/default/files/documents/COVID-19-geographic-disbtribution-worldwide-'+now.strftime("%Y")+'-'+now.strftime("%m")+'-'+now.strftime("%d")+'.xlsxp'

filenm = 'https://www.ecdc.europa.eu/sites/default/files/documents/COVID-19-geographic-disbtribution-worldwide-2020-09-24.xlsx'
...
try:
    ...
    print(err.code)
    ### here we need to go back a day so if we run it before ecdc update
    ### it will work on yesterday's date
