...
datas = ['new_cases_smoothed_per_million','new_deaths_smoothed_per_million']
...
with PdfPages(pdfname) as pdf:
    ...
    for ctry in chosen_countries:
        ...
        ax2, ax2a = twinaxes(ax2, plotdf.index, plotdf.driving, plotdf.TT, 'r', 'g', 'Driving (red)', 'Traffic congestion (gold)')
